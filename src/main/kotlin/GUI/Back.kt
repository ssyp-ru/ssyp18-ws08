...
class Back(gc: GameContainer) : Button(gc, imageCommon = Image("res/back1.png"), imageLighted = Image("res/back2.png"),
        imageClicked = Image("res/back3.png"), sizeX = gc.screenWidth.toFloat() / 6f, sizeY = gc.screenWidth.toFloat() / 16f,
